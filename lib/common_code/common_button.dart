...
Widget CommonButton({String? txt1,String? txt2,required Color containcolore,context,required void Function() onPressed1,bool? error}){
  return  Container(
      height: 45,
      ...
      child: ElevatedButton(
        ...
        onPressed: error != null && error ? () {} : onPressed1,
        child: Center(
...
Widget CommonTextfiled10({required BuildContext context, TextEditingController? controller, String? txt, String? Function(String?)? validator,}) {
