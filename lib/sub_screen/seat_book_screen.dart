...
class _Seat_Book_State extends State<Seat_Book_> {
    ...
    try{
      ...
      if(response.statusCode == 200){
        setState(() {
          ...
          isloading = false;
          print("|||||||||||| BUS PICKUP TIME |||||||||||| :- ${widget.busPicktime}");
  ...
  @override
  void initState() {
    print("IS SLEEPER:- ${widget.isSleeper}");
    print("IS SLEEPER:- ${widget.bus_id}");
    _resetSelectedDate();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: (selectset1.isEmpty && selectset.isEmpty) ? const SizedBox() : Row(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //               return SizedBox(
                    //                 height: 60,
                    //                 // height: widget.isSleeper == '1' ?  80 : 80,
                    //                 width: 100,
                    ...
                    //                               image:
                    //
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].gender == 'FEMALE' ?
                    //
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Booked by female passenger.png'),) :
                    //                               const DecorationImage(image: AssetImage('assets/Ldise_Set.png'),fit: BoxFit.fill):
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].isBooked ?
                    //
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selec_Sit_Setter.png'),) :
                    //                               const DecorationImage(image: AssetImage('assets/selection_set.png'),fit: BoxFit.fill) :
                    //                               selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber) ?
                    //
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selected By you.png'),) :
                    //                               const DecorationImage(image: AssetImage('assets/selections 1.png'),fit: BoxFit.fill) :
                    //
                    //                               data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Available.png'),) :
                    //                               const DecorationImage(image: AssetImage('assets/selections 2.png'),fit: BoxFit.fill)
                    //                           ),
                    ...
                    //                               height: 60,
                    //                               width: 35,
                    //                               // height: data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? 70 : 48,
                    //                               // width: data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? 35 : 45,
                    //                               margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                    //                               decoration: BoxDecoration(
                    //                                   image:
                    //
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].gender == 'FEMALE' ?
                    //
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Booked by female passenger.png'),) :
                    //                                   const DecorationImage(image: AssetImage('assets/Ldise_Set.png'),fit: BoxFit.fill) :
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].isBooked ?
                    //
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selec_Sit_Setter.png'),) :
                    //                                   const DecorationImage(image: AssetImage('assets/selection_set.png'),fit: BoxFit.fill) :
                    //                                   selectset1.contains(data!.busLayoutData[0].upperLayout[index1][index].seatNumber) ?
                    //
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selected By you.png'),) :
                    //                                   const DecorationImage(image: AssetImage('assets/selections 1.png'),fit: BoxFit.fill) :
                    //
                    //                                   data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Available.png'),) :
                    //                                   const DecorationImage(image: AssetImage('assets/selections 2.png'),fit: BoxFit.fill)
                    //                               ),
                    ...
                    data!.busLayoutData[0].upperLayout.isEmpty ? Container(
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index1) {
                                  ...
                                  return SizedBox(
                                    height: 60,
                                    // height: (widget.isSleeper == '1' || widget.isSleeper == '2') ?  58 : 70,
                                    width: 100,
                                    child: ListView.builder(
                                        shrinkWrap: true,
                                        physics: const NeverScrollableScrollPhysics(),
                                          ...
                                          return data?.busLayoutData[0].lowerLayout[index1][index].seatNumber == "" ?  Container(
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].gender == 'FEMALE' ?
                                                  //
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Booked by female passenger.png'),fit: BoxFit.fill) :
                                                  // const DecorationImage(image: AssetImage('assets/Ldise_Set.png'),fit: BoxFit.fill) :
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].isBooked ?
                                                  //
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selec_Sit_Setter.png'),fit: BoxFit.fill) :
                                                  // const DecorationImage(image: AssetImage('assets/selection_set.png'),fit: BoxFit.fill) :
                                                  // selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber) ?
                                                  //
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selected By you.png'),fit: BoxFit.fill) :
                                                  // const DecorationImage(image: AssetImage('assets/selections 1.png'),fit: BoxFit.fill) :
                                                  //
                                                  // data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Available.png'),fit: BoxFit.fill) :
                                                  // const DecorationImage(image: AssetImage('assets/selections 2.png'),fit: BoxFit.fill)
                                              ),
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  ...
                                                  data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                      ? Image.asset('assets/Booked by female passenger.png',fit: BoxFit.fill,width: 45,height: 60,)
                                                      : Image.asset('assets/Ldise_Set.png',width: 40,fit: BoxFit.fill,height: 72,)
                                                      : data!.busLayoutData[0].lowerLayout[index1][index].isBooked
                                                      ? data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                      ? Image.asset('assets/Selec_Sit_Setter.png',fit: BoxFit.fill,width: 45,height: 60,)
                                                      : Image.asset('assets/selection_set.png',width: 40,fit: BoxFit.fill,height: 72,)
                                                      : selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber)
                                                      ? data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                      ? Image.asset('assets/Selected By you.png',fit: BoxFit.fill,width: 45,height: 60,)
                                                      : Image.asset('assets/selections 1.png',width: 40,fit: BoxFit.fill,height: 72,) :

                                                  data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? Image.asset('assets/Available.png',fit: BoxFit.fill,width: 45,height: 60,) :
                                                  Image.asset('assets/selections 2.png',width: 40,fit: BoxFit.fill,height: 72,),


                                                  Center(child: Text(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber,style: const TextStyle(fontSize: 10,color: Colors.grey),)),
                                                ],
                                              ),
                                              // child: Center(child: Text(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber,style: const TextStyle(fontSize: 10,color: Colors.grey),)),
                                            ):
                      ...
                      // height: 650,
                      width: (widget.isSleeper == '2') ? double.parse((59 * data!.busLayoutData[0].lowerLayout[0].length).toString()) : (widget.isSleeper == '1') ?  double.parse((50 * data!.busLayoutData[0].lowerLayout[0].length).toString()) : double.parse((61 * data!.busLayoutData[0].lowerLayout[0].length).toString()),
                      // width: 175 ,
                      decoration: BoxDecoration(
                        color: notifier.containercoloreproper,
                        // color: Colors.red,
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index1) {
                                  ...
                                  return Container(
                                    ...
                                    height: (widget.isSleeper == '0') ? 58 : (widget.isSleeper == '1') ? 80 : data!.busLayoutData[0].lowerLayout[index1][valuindex].seatType == "seat" ? 58 : 85,
                                    // height: (widget.isSleeper == '1') ? 80 : 58,
                                    width: 100,
                                    // color: Colors.red,
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return data?.busLayoutData[0].lowerLayout[index1][index].seatNumber == "" ? Container(
                                            height: 60,
                                            // width: (widget.isSleeper == '1' || widget.isSleeper == '2') ? 35 : 45,
                                            width: (widget.isSleeper == '1') ? 35 : 45,
                                            margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                                          ) : InkWell(
                                            onTap: () {
                                            ...
                                            widget.isSleeper == '2' ?
                                            Container(
                                              height: data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? 60 : 60,
                                              width: data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ?  45 : 45,
                                              margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                                              decoration: BoxDecoration(
                                                // color: Colors.red,
                                                //   image:2                                                //   data!.busLayoutData[0].lowerLayout[index1][index].gender == 'FEMALE' ?
                                                //
                                                //   data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                //       ? const DecorationImage(image: AssetImage('assets/Booked by female passenger.png'),fit: BoxFit.fill)
                                                //       : const DecorationImage(image: AssetImage('assets/Ldise_Set.png'))
                                                //       : data!.busLayoutData[0].lowerLayout[index1][index].isBooked
                                                //       ? data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                //       ? const DecorationImage(image: AssetImage('assets/Selec_Sit_Setter.png'),fit: BoxFit.fill)
                                                //       : const DecorationImage(image: AssetImage('assets/selection_set.png'))
                                                //       : selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber)
                                                //       ? data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat"
                                                //       ? const DecorationImage(image: AssetImage('assets/Selected By you.png'),fit: BoxFit.fill)
                                                //       : const DecorationImage(image: AssetImage('assets/selections 1.png')) :
                                                //
                                                //   data!.busLayoutData[0].lowerLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Available.png'),fit: BoxFit.fill) :
                                                //   const DecorationImage(image: AssetImage('assets/selections 2.png'))
                                              ),
                                              child: Stack(
                                                alignment: Alignment.center,
                                                children: [
                    ...
                    data!.busLayoutData[0].upperLayout.isEmpty ? const SizedBox() : Container(
                      // height: 650,
                      width: (widget.isSleeper == '2') ? double.parse((58 * data!.busLayoutData[0].upperLayout[0].length).toString()) : (widget.isSleeper == '1') ? double.parse((50 * data!.busLayoutData[0].upperLayout[0].length).toString()) : double.parse((61 * data!.busLayoutData[0].upperLayout[0].length).toString()),
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index1) {
                                  ...
                                  return SizedBox(
                                    // height: widget.isSleeper == '1' ? 80 : 58,
                                    // height: (widget.isSleeper == '1' || widget.isSleeper == '2') ? 80 : 58,
                                    height: (widget.isSleeper == '0') ? 58 : (widget.isSleeper == '1') ? 80 : data!.busLayoutData[0].upperLayout[index1][valuindex1].seatType == "seat" ? 58 : 80,
                                    width: 100,
                                    child: ListView.builder(
                                        physics: const NeverScrollableScrollPhysics(),
                                        shrinkWrap: true,
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return data?.busLayoutData[0].upperLayout[index1][index].seatNumber == "" ? Container(
                                            // height: widget.isSleeper == '1' ?  80 : 60,
                                            // width: widget.isSleeper == '1' ?  35 : 45,
                                            height: (widget.isSleeper == '1' || widget.isSleeper == '2') ?  80 : 60,
                                            width: (widget.isSleeper == '1') ?  35 : 45,
                                            margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                                          ) : InkWell(
                                            onTap: () {
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Container(
                                                  // height: 60,
                                                  // width: 35,
                                                  height: data!.busLayoutData[0].upperLayout[index1][index].seatType == "sofa" ? 70 : 48,
                                                  width: data!.busLayoutData[0].upperLayout[index1][index].seatType == "sofa" ? 45 : 45,
                                                  margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                                                  decoration: BoxDecoration(
                                                      // image:
                                                      //
                                                      // data!.busLayoutData[0].upperLayout[index1][index].gender == 'FEMALE' ?
                                                      //
                                                      // data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Booked by female passenger.png'),fit: BoxFit.fill) :
                                                      // const DecorationImage(image: AssetImage('assets/Ldise_Set.png'),fit: BoxFit.fill) :
                                                      // data!.busLayoutData[0].upperLayout[index1][index].isBooked ?
                                                      //
                                                      // data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selec_Sit_Setter.png'),fit: BoxFit.fill) :
                                                      // const DecorationImage(image: AssetImage('assets/selection_set.png'),fit: BoxFit.fill) :
                                                      // selectset1.contains(data!.busLayoutData[0].upperLayout[index1][index].seatNumber) ?
                                                      //
                                                      // data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Selected By you.png'),fit: BoxFit.fill) :
                                                      // const DecorationImage(image: AssetImage('assets/selections 1.png'),fit: BoxFit.fill) :
                                                      //
                                                      // data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? const DecorationImage(image: AssetImage('assets/Available.png'),fit: BoxFit.fill) :
                                                      // const DecorationImage(image: AssetImage('assets/selections 2.png'),fit: BoxFit.fill)
                                                  ),
                                                  child: Stack(
                                                    alignment: Alignment.center,
                                                    children: [
                                                      ...
                                                      data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat"
                                                          ? Image.asset('assets/Booked by female passenger.png',fit: BoxFit.fill,width: 45,height: 60,)
                                                          : Image.asset('assets/Ldise_Set.png',width: 40,fit: BoxFit.fill,height: 72,)
                                                          : data!.busLayoutData[0].upperLayout[index1][index].isBooked
                                                          ? data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat"
                                                      ...
                                                      data!.busLayoutData[0].upperLayout[index1][index].seatType == "seat" ? Image.asset('assets/Available.png',fit: BoxFit.fill,width: 45,height: 60,) :
                                                      Image.asset('assets/selections 2.png',width: 40,fit: BoxFit.fill,height: 72,),


                                                      Center(child: Text(data!.busLayoutData[0].upperLayout[index1][index].seatNumber,style: const TextStyle(fontSize: 10,color: Colors.grey),)),
                                                    ],
                                                  ),
                                                  // child: Center(child: Text(data!.busLayoutData[0].upperLayout[index1][index].seatNumber,style: const TextStyle(fontSize: 10,color: Colors.grey),)),
                                                ):
