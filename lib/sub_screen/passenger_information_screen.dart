                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(10),
                                      borderSide: BorderSide(color: error ? Colors.red : Colors.grey.withOpacity(0.4))),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Email Id'.tr, style: TextStyle(fontSize: 14, color: notifier.textColor),maxLines: 1),
                              const SizedBox(height: 6),
                              TextFormField(
                                style: TextStyle(color: notifier.textColor),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Contact Details'.tr, style: TextStyle(fontSize: 14, color: notifier.textColor), maxLines: 1),
                              const SizedBox(height: 6,),
                              TextFormField(
                                style: TextStyle(color: notifier.textColor),
