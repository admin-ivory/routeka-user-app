...
class _ReferFriendScreenState extends State<ReferFriendScreen> {
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ButtonStyle(backgroundColor: MaterialStatePropertyAll<Color?>(notifier.theamcolorelight),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)))),
  ...
  Future<void> share() async {
    ...
    final String text =
        ...
        'Enter my referral code $searchbus${data.signupcredit} & Enjoy your shopping !!!';
