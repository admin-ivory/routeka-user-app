...
//
//     final pracelListApiModel = pracelListApiModelFromJson(jsonString);

import 'dart:convert';

PracelListApiModel pracelListApiModelFromJson(String str) => PracelListApiModel.fromJson(json.decode(str));

String pracelListApiModelToJson(PracelListApiModel data) => json.encode(data.toJson());

class PracelListApiModel {
  String? responseCode;
  String? result;
  String? responseMsg;
  ...
  factory PracelListApiModel.fromJson(Map<String, dynamic> json) => PracelListApiModel(
